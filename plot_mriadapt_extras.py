...
import sys
sys.path.append('..')
import plot_utilities_extras as putil
import pandas as pd
...
if Plot_KPR:
    putil.do_comparison_plots(KPR_fname, 'omega', [50, 500], r'$\omega$', Full_controllers,'All controller',
                              'extra-kpr',kpr_removed_pairs,'kpr_ranks',kpr_xlim_lo,kpr_xlim_mid,kpr_xlim_hi,Hh,Htol,Decoupled)

if Plot_Bruss:
    putil.do_comparison_plots(Bruss_fname, 'ep', [1.e-4, 1.e-5], r'$\epsilon$', Full_controllers, 'All controller',
                              'extra-bruss', bruss_removed_pairs,'bruss_ranks',bruss_xlim_lo,bruss_xlim_mid,bruss_xlim_hi,Hh,Htol,Decoupled)
