...
data_KPR_slowOrd45_HTol_I["MRI_zScore_SMO45_KPR_HTol_I"] = data_KPR_slowOrd45_HTol_I["MRIMethod"].map(methodAvg_KPR_slowOrd45_HTol_I)
data_KPR_slowOrd45_HTol_I["MRI_zScore_SMO45_KPR_HTol_I"] = (data_KPR_slowOrd45_HTol_I["MRI_zScore_SMO45_KPR_HTol_I"] - allAvg_KPR_slowOrd45_HTol_I)/allStd_KPR_slowOrd45_HTol_I 

# ----------------------------- Classify each method based on z-score ------------------------------------
conditions = [
    data_KPR_slowOrd45_HTol_I["MRI_zScore_SMO45_KPR_HTol_I"] < -zscore_threshold,
    data_KPR_slowOrd45_HTol_I["MRI_zScore_SMO45_KPR_HTol_I"] > zscore_threshold
]

data_KPR_slowOrd45_HTol_I["MRI_status_SMO45_KPR_HTol_I"] = np.select(conditions, status, default="intermediate")
...
# ------ Calculate the z-score of each method and store on each row corresponding to the method ----
data_KPR_slowOrd45_Dec_I["MRI_zScore_SMO45_KPR_Dec_I"] = data_KPR_slowOrd45_Dec_I["MRIMethod"].map(methodAvg_KPR_slowOrd45_Dec_I)
data_KPR_slowOrd45_Dec_I["MRI_zScore_SMO45_KPR_Dec_I"] = (data_KPR_slowOrd45_Dec_I["MRI_zScore_SMO45_KPR_Dec_I"] - allAvg_KPR_slowOrd45_Dec_I)/allStd_KPR_slowOrd45_Dec_I 

# ----------------------------- Classify each method based on z-score ------------------------------------
conditions = [
    data_KPR_slowOrd45_Dec_I["MRI_zScore_SMO45_KPR_Dec_I"] < -zscore_threshold,
    data_KPR_slowOrd45_Dec_I["MRI_zScore_SMO45_KPR_Dec_I"] > zscore_threshold
]

data_KPR_slowOrd45_Dec_I["MRI_status_SMO45_KPR_Dec_I"] = np.select(conditions, status, default="intermediate")
...
# ------ Calculate the z-score of each method and store on each row corresponding to the method ----
data_KPR_slowOrd45_HTol_H0321["MRI_zScore_SMO45_KPR_HTol_H0321"] = data_KPR_slowOrd45_HTol_H0321["MRIMethod"].map(methodAvg_KPR_slowOrd45_HTol_H0321)
data_KPR_slowOrd45_HTol_H0321["MRI_zScore_SMO45_KPR_HTol_H0321"] = (data_KPR_slowOrd45_HTol_H0321["MRI_zScore_SMO45_KPR_HTol_H0321"] - allAvg_KPR_slowOrd45_HTol_H0321)/allStd_KPR_slowOrd45_HTol_H0321 

# ----------------------------- Classify each method based on z-score ------------------------------------
conditions = [
    data_KPR_slowOrd45_HTol_H0321["MRI_zScore_SMO45_KPR_HTol_H0321"] < -zscore_threshold,
    data_KPR_slowOrd45_HTol_H0321["MRI_zScore_SMO45_KPR_HTol_H0321"] > zscore_threshold
]

data_KPR_slowOrd45_HTol_H0321["MRI_status_SMO45_KPR_HTol_H0321"] = np.select(conditions, status, default="intermediate")
...
# ------ Calculate the z-score of each method and store on each row corresponding to the method ----
data_KPR_slowOrd45_Dec_H0321["MRI_zScore_SMO45_KPR_Dec_H0321"] = data_KPR_slowOrd45_Dec_H0321["MRIMethod"].map(methodAvg_KPR_slowOrd45_Dec_H0321)
data_KPR_slowOrd45_Dec_H0321["MRI_zScore_SMO45_KPR_Dec_H0321"] = (data_KPR_slowOrd45_Dec_H0321["MRI_zScore_SMO45_KPR_Dec_H0321"] - allAvg_KPR_slowOrd45_Dec_H0321)/allStd_KPR_slowOrd45_Dec_H0321 

# ----------------------------- Classify each method based on z-score ------------------------------------
conditions = [
    data_KPR_slowOrd45_Dec_H0321["MRI_zScore_SMO45_KPR_Dec_H0321"] < -zscore_threshold,
    data_KPR_slowOrd45_Dec_H0321["MRI_zScore_SMO45_KPR_Dec_H0321"] > zscore_threshold
]

data_KPR_slowOrd45_Dec_H0321["MRI_status_SMO45_KPR_Dec_H0321"] = np.select(conditions, status, default="intermediate")
...
# ------ Calculate the z-score of each method and store on each row corresponding to the method ----
data_KPR_slowOrd45_HTol_H211["MRI_zScore_SMO45_KPR_HTol_H211"] = data_KPR_slowOrd45_HTol_H211["MRIMethod"].map(methodAvg_KPR_slowOrd45_HTol_H211)
data_KPR_slowOrd45_HTol_H211["MRI_zScore_SMO45_KPR_HTol_H211"] = (data_KPR_slowOrd45_HTol_H211["MRI_zScore_SMO45_KPR_HTol_H211"] - allAvg_KPR_slowOrd45_HTol_H211)/allStd_KPR_slowOrd45_HTol_H211 

# ----------------------------- Classify each method based on z-score ------------------------------------
conditions = [
    data_KPR_slowOrd45_HTol_H211["MRI_zScore_SMO45_KPR_HTol_H211"] < -zscore_threshold,
    data_KPR_slowOrd45_HTol_H211["MRI_zScore_SMO45_KPR_HTol_H211"] > zscore_threshold
]

data_KPR_slowOrd45_HTol_H211["MRI_status_SMO45_KPR_HTol_H211"] = np.select(conditions, status, default="intermediate")
...
# ------ Calculate the z-score of each method and store on each row corresponding to the method ----
data_KPR_slowOrd45_Dec_H211["MRI_zScore_SMO45_KPR_Dec_H211"] = data_KPR_slowOrd45_Dec_H211["MRIMethod"].map(methodAvg_KPR_slowOrd45_Dec_H211)
data_KPR_slowOrd45_Dec_H211["MRI_zScore_SMO45_KPR_Dec_H211"] = (data_KPR_slowOrd45_Dec_H211["MRI_zScore_SMO45_KPR_Dec_H211"] - allAvg_KPR_slowOrd45_Dec_H211)/allStd_KPR_slowOrd45_Dec_H211 

# ----------------------------- Classify each method based on z-score ------------------------------------
conditions = [
    data_KPR_slowOrd45_Dec_H211["MRI_zScore_SMO45_KPR_Dec_H211"] < -zscore_threshold,
    data_KPR_slowOrd45_Dec_H211["MRI_zScore_SMO45_KPR_Dec_H211"] > zscore_threshold
]

data_KPR_slowOrd45_Dec_H211["MRI_status_SMO45_KPR_Dec_H211"] = np.select(conditions, status, default="intermediate")
...
# ------ Calculate the z-score of each method and store on each row corresponding to the method ----
data_KPR_slowOrd45_HTol_H0211["MRI_zScore_SMO45_KPR_HTol_H0211"] = data_KPR_slowOrd45_HTol_H0211["MRIMethod"].map(methodAvg_KPR_slowOrd45_HTol_H0211)
data_KPR_slowOrd45_HTol_H0211["MRI_zScore_SMO45_KPR_HTol_H0211"] = (data_KPR_slowOrd45_HTol_H0211["MRI_zScore_SMO45_KPR_HTol_H0211"] - allAvg_KPR_slowOrd45_HTol_H0211)/allStd_KPR_slowOrd45_HTol_H0211 

# ----------------------------- Classify each method based on z-score ------------------------------------
conditions = [
    data_KPR_slowOrd45_HTol_H0211["MRI_zScore_SMO45_KPR_HTol_H0211"] < -zscore_threshold,
    data_KPR_slowOrd45_HTol_H0211["MRI_zScore_SMO45_KPR_HTol_H0211"] > zscore_threshold
]

data_KPR_slowOrd45_HTol_H0211["MRI_status_SMO45_KPR_HTol_H0211"] = np.select(conditions, status, default="intermediate")
...
# ------ Calculate the z-score of each method and store on each row corresponding to the method ----
data_KPR_slowOrd45_Dec_H0211["MRI_zScore_SMO45_KPR_Dec_H0211"] = data_KPR_slowOrd45_Dec_H0211["MRIMethod"].map(methodAvg_KPR_slowOrd45_Dec_H0211)
data_KPR_slowOrd45_Dec_H0211["MRI_zScore_SMO45_KPR_Dec_H0211"] = (data_KPR_slowOrd45_Dec_H0211["MRI_zScore_SMO45_KPR_Dec_H0211"] - allAvg_KPR_slowOrd45_Dec_H0211)/allStd_KPR_slowOrd45_Dec_H0211 

# ----------------------------- Classify each method based on z-score ------------------------------------
conditions = [
    data_KPR_slowOrd45_Dec_H0211["MRI_zScore_SMO45_KPR_Dec_H0211"] < -zscore_threshold,
    data_KPR_slowOrd45_Dec_H0211["MRI_zScore_SMO45_KPR_Dec_H0211"] > zscore_threshold
]

data_KPR_slowOrd45_Dec_H0211["MRI_status_SMO45_KPR_Dec_H0211"] = np.select(conditions, status, default="intermediate")
...
# ------ Calculate the z-score of each method and store on each row corresponding to the method ----
data_KPR_slowOrd45_HTol_H312["MRI_zScore_SMO45_KPR_HTol_H312"] = data_KPR_slowOrd45_HTol_H312["MRIMethod"].map(methodAvg_KPR_slowOrd45_HTol_H312)
data_KPR_slowOrd45_HTol_H312["MRI_zScore_SMO45_KPR_HTol_H312"] = (data_KPR_slowOrd45_HTol_H312["MRI_zScore_SMO45_KPR_HTol_H312"] - allAvg_KPR_slowOrd45_HTol_H312)/allStd_KPR_slowOrd45_HTol_H312 

# ----------------------------- Classify each method based on z-score ------------------------------------
conditions = [
    data_KPR_slowOrd45_HTol_H312["MRI_zScore_SMO45_KPR_HTol_H312"] < -zscore_threshold,
    data_KPR_slowOrd45_HTol_H312["MRI_zScore_SMO45_KPR_HTol_H312"] > zscore_threshold
]

data_KPR_slowOrd45_HTol_H312["MRI_status_SMO45_KPR_HTol_H312"] = np.select(conditions, status, default="intermediate")
...
# ------ Calculate the z-score of each method and store on each row corresponding to the method ----
data_KPR_slowOrd45_Dec_H312["MRI_zScore_SMO45_KPR_Dec_H312"] = data_KPR_slowOrd45_Dec_H312["MRIMethod"].map(methodAvg_KPR_slowOrd45_Dec_H312)
data_KPR_slowOrd45_Dec_H312["MRI_zScore_SMO45_KPR_Dec_H312"] = (data_KPR_slowOrd45_Dec_H312["MRI_zScore_SMO45_KPR_Dec_H312"] - allAvg_KPR_slowOrd45_Dec_H312)/allStd_KPR_slowOrd45_Dec_H312 

# ----------------------------- Classify each method based on z-score ------------------------------------
conditions = [
    data_KPR_slowOrd45_Dec_H312["MRI_zScore_SMO45_KPR_Dec_H312"] < -zscore_threshold,
    data_KPR_slowOrd45_Dec_H312["MRI_zScore_SMO45_KPR_Dec_H312"] > zscore_threshold
]

data_KPR_slowOrd45_Dec_H312["MRI_status_SMO45_KPR_Dec_H312"] = np.select(conditions, status, default="intermediate")
