...
#######################################################################################################################
# ---------------------- Select only fast 4th and 5th order methods with MRIHTol-I controller (KPR) -------------------------------
data_KPR_fastOrd45_HTol_I = df[(df["order"].isin([4, 5])) & (df["metric"] == "fast") & (df["Param"].isin([50, 500])) & (df["Controller"] == "MRIHTol-I")][["metric", "order", "Param", "MRIMethod", "Controller", "AvgRank"]]

# ----------------------- Mean and standard deviation of the selected data (KPR, Fast, Order 4 and 5, MRIHTol-I) ----------------------
allAvg_KPR_fastOrd45_HTol_I = data_KPR_fastOrd45_HTol_I["AvgRank"].mean()
allStd_KPR_fastOrd45_HTol_I = data_KPR_fastOrd45_HTol_I["AvgRank"].std()
...
#######################################################################################################################
# ---------------------- Select only fast 4th and 5th order methods with MRIDec-I controller (KPR) -------------------------------
data_KPR_fastOrd45_Dec_I = df[(df["order"].isin([4, 5])) & (df["metric"] == "fast") & (df["Param"].isin([50, 500])) & (df["Controller"] == "MRIDec-I")][["metric", "order", "Param", "MRIMethod", "Controller", "AvgRank"]]

# ----------------------- Mean and standard deviation of the selected data (KPR, Fast, Order 4 and 5, MRIDec-I) ----------------------
allAvg_KPR_fastOrd45_Dec_I = data_KPR_fastOrd45_Dec_I["AvgRank"].mean()
allStd_KPR_fastOrd45_Dec_I = data_KPR_fastOrd45_Dec_I["AvgRank"].std()
...
#######################################################################################################################
# ---------------------- Select only fast 4th and 5th order methods with MRIHTol-H0321 controller (KPR) -------------------------------
data_KPR_fastOrd45_HTol_H0321 = df[(df["order"].isin([4, 5])) & (df["metric"] == "fast") & (df["Param"].isin([50, 500])) & (df["Controller"] == "MRIHTol-H0321")][["metric", "order", "Param", "MRIMethod", "Controller", "AvgRank"]]

# ----------------------- Mean and standard deviation of the selected data (KPR, Fast, Order 4 and 5, MRIHTol-H0321) ----------------------
allAvg_KPR_fastOrd45_HTol_H0321 = data_KPR_fastOrd45_HTol_H0321["AvgRank"].mean()
allStd_KPR_fastOrd45_HTol_H0321= data_KPR_fastOrd45_HTol_H0321["AvgRank"].std()
...
#######################################################################################################################
# ---------------------- Select only fast 4th and 5th order methods with MRIDec-H0321 controller (KPR) -------------------------------
data_KPR_fastOrd45_Dec_H0321 = df[(df["order"].isin([4, 5])) & (df["metric"] == "fast") & (df["Param"].isin([50, 500])) & (df["Controller"] == "MRIDec-H0321")][["metric", "order", "Param", "MRIMethod", "Controller", "AvgRank"]]

# ----------------------- Mean and standard deviation of the selected data (KPR, Fast, Order 4 and 5, MRIDec-H0321) ----------------------
allAvg_KPR_fastOrd45_Dec_H0321 = data_KPR_fastOrd45_Dec_H0321["AvgRank"].mean()
allStd_KPR_fastOrd45_Dec_H0321= data_KPR_fastOrd45_Dec_H0321["AvgRank"].std()
...
#######################################################################################################################
# ---------------------- Select only fast 4th and 5th order methods with MRIHTol-H211 controller (KPR) -------------------------------
data_KPR_fastOrd45_HTol_H211 = df[(df["order"].isin([4, 5])) & (df["metric"] == "fast") & (df["Param"].isin([50, 500])) & (df["Controller"] == "MRIHTol-H211")][["metric", "order", "Param", "MRIMethod", "Controller", "AvgRank"]]

# ----------------------- Mean and standard deviation of the selected data (KPR, Fast, Order 4 and 5, MRIHTol-H211) ----------------------
allAvg_KPR_fastOrd45_HTol_H211 = data_KPR_fastOrd45_HTol_H211["AvgRank"].mean()
allStd_KPR_fastOrd45_HTol_H211 = data_KPR_fastOrd45_HTol_H211["AvgRank"].std()
...
#######################################################################################################################
# ---------------------- Select only fast 4th and 5th order methods with MRIDec-H211 controller (KPR) -------------------------------
data_KPR_fastOrd45_Dec_H211 = df[(df["order"].isin([4, 5])) & (df["metric"] == "fast") & (df["Param"].isin([50, 500])) & (df["Controller"] == "MRIDec-H211")][["metric", "order", "Param", "MRIMethod", "Controller", "AvgRank"]]

# ----------------------- Mean and standard deviation of the selected data (KPR, Fast, Order 4 and 5, MRIDec-H211) ----------------------
allAvg_KPR_fastOrd45_Dec_H211 = data_KPR_fastOrd45_Dec_H211["AvgRank"].mean()
allStd_KPR_fastOrd45_Dec_H211= data_KPR_fastOrd45_Dec_H211["AvgRank"].std()
...
#######################################################################################################################
# ---------------------- Select only fast 4th and 5th order methods with MRIHTol-H0211 controller (KPR) -------------------------------
data_KPR_fastOrd45_HTol_H0211 = df[(df["order"].isin([4, 5])) & (df["metric"] == "fast") & (df["Param"].isin([50, 500])) & (df["Controller"] == "MRIHTol-H0211")][["metric", "order", "Param", "MRIMethod", "Controller", "AvgRank"]]

# ----------------------- Mean and standard deviation of the selected data (KPR, Fast, Order 4 and 5, MRIHTol-H0211) ----------------------
allAvg_KPR_fastOrd45_HTol_H0211 = data_KPR_fastOrd45_HTol_H0211["AvgRank"].mean()
allStd_KPR_fastOrd45_HTol_H0211 = data_KPR_fastOrd45_HTol_H0211["AvgRank"].std()
...
#######################################################################################################################
# ---------------------- Select only fast 4th and 5th order methods with MRIDec-H0211 controller (KPR) -------------------------------
data_KPR_fastOrd45_Dec_H0211 = df[(df["order"].isin([4, 5])) & (df["metric"] == "fast") & (df["Param"].isin([50, 500])) & (df["Controller"] == "MRIDec-H0211")][["metric", "order", "Param", "MRIMethod", "Controller", "AvgRank"]]

# ----------------------- Mean and standard deviation of the selected data (KPR, Fast, Order 4 and 5, MRIDec-H0211) ----------------------
allAvg_KPR_fastOrd45_Dec_H0211 = data_KPR_fastOrd45_Dec_H0211["AvgRank"].mean()
allStd_KPR_fastOrd45_Dec_H0211= data_KPR_fastOrd45_Dec_H0211["AvgRank"].std()
...
#######################################################################################################################
# ---------------------- Select only fast 4th and 5th order methods with MRIHTol-H312 controller (KPR) -------------------------------
data_KPR_fastOrd45_HTol_H312 = df[(df["order"].isin([4, 5])) & (df["metric"] == "fast") & (df["Param"].isin([50, 500])) & (df["Controller"] == "MRIHTol-H312")][["metric", "order", "Param", "MRIMethod", "Controller", "AvgRank"]]

# ----------------------- Mean and standard deviation of the selected data (KPR, Fast, Order 4 and 5, MRIHTol-H312) ----------------------
allAvg_KPR_fastOrd45_HTol_H312 = data_KPR_fastOrd45_HTol_H312["AvgRank"].mean()
allStd_KPR_fastOrd45_HTol_H312 = data_KPR_fastOrd45_HTol_H312["AvgRank"].std()
...
#######################################################################################################################
# ---------------------- Select only fast 4th and 5th order methods with MRIDec-H312 controller (KPR) -------------------------------
data_KPR_fastOrd45_Dec_H312 = df[(df["order"].isin([4, 5])) & (df["metric"] == "fast") & (df["Param"].isin([50, 500])) & (df["Controller"] == "MRIDec-H312")][["metric", "order", "Param", "MRIMethod", "Controller", "AvgRank"]]

# ----------------------- Mean and standard deviation of the selected data (KPR, Fast, Order 4 and 5, MRIDec-H312) ----------------------
allAvg_KPR_fastOrd45_Dec_H312 = data_KPR_fastOrd45_Dec_H312["AvgRank"].mean()
allStd_KPR_fastOrd45_Dec_H312= data_KPR_fastOrd45_Dec_H312["AvgRank"].std()
...
with pd.ExcelWriter('allKPR_fastOrder45.xlsx') as writer:
    data_KPR_fastOrd45_HTol_I.to_excel(writer, sheet_name='data_KPR_fastOrd45_HTol_I', index=False)
    data_KPR_fastOrd45_Dec_I.to_excel(writer, sheet_name='data_KPR_fastOrd45_Dec_I', index=False)

    data_KPR_fastOrd45_HTol_H0321.to_excel(writer, sheet_name='data_KPR_fastOrd45_HTol_H0321', index=False)
    data_KPR_fastOrd45_Dec_H0321.to_excel(writer, sheet_name='data_KPR_fastOrd45_Dec_H0321', index=False)

    data_KPR_fastOrd45_HTol_H211.to_excel(writer, sheet_name='data_KPR_fastOrd45_HTol_H211', index=False)
    data_KPR_fastOrd45_Dec_H211.to_excel(writer, sheet_name='data_KPR_fastOrd45_Dec_H211', index=False)

    data_KPR_fastOrd45_HTol_H0211.to_excel(writer, sheet_name='data_KPR_fastOrd45_HTol_H0211', index=False)
    data_KPR_fastOrd45_Dec_H0211.to_excel(writer, sheet_name='data_KPR_fastOrd45_Dec_H0211', index=False)
