...
# ------------------------------------------------------------------------------
# --------------------------------------------------------------------------------------------------------------------------
# This script calculates the z-scores for all controllers (except H-h controllers), for the stiff Brusselator and KPR test problems.
...
for prb_key, prb_val in params.items():
        ...
        fileName  = f"{prb_key}_controllers.xlsx"
        ...
        # compute the average z-score of controller or across each worksheet
        ...
        textFileName = f"AvgZscores_{prb_key}.txt"
        with open(textFileName, "w") as file:
                file.write(f"********************************************************************************************** \n")
                file.write(f"Below are the average z-scores for the various controllers, for the {prb_key} test. \n")
                file.write(f"********************************************************************************************** \n\n")
